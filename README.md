...
Run the script:
# python CDS_Data_Validation.py Input: FASTA files in input_dir (configured in script).
...
Usage
python CDS_Codon_Freq_CSV.py Input Directory: Configure input_dir in the script (default: Final_Filtered).
