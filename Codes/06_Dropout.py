# -*- coding: utf-8 -*-
"""
Created on Tue Jun 24 16:01:39 2025
...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar  8 14:40:53 2025
...
# Define Dropout Neural Network model
...
best_val_acc = 0.0
best_model_path = os.path.join(output_dir, "Best_DNN_Model.h5")
...
for fold, (train_index, val_index) in enumerate(kf.split(X_train)):
    ...
    # Save model
    model_path = os.path.join(output_dir, f"DropoutNN_fold{fold+1}.h5")
...
results_df.to_csv('E:/Bras/Dropout/DO_Results.csv', index=False)
...
# Plot confusion matrix with improved colors
...
plt.title('Confusion Matrix - Dropout NN', fontsize=16)
...
plt.title('Training and Validation Accuracy - Dropout NN', fontsize=16)
plt.legend()
plt.grid(True)
