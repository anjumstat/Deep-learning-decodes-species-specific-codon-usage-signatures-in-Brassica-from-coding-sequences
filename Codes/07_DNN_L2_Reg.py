# -*- coding: utf-8 -*-
"""
Created on Tue Jun 24 15:55:00 2025
...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar  8 15:29:05 2025
...
# Define L2 Regularized Neural Network model
...
best_val_acc = 0.0
best_model_path = os.path.join(output_dir, "Best_L2_DNN_Model.h5")
...
for fold, (train_index, val_index) in enumerate(kf.split(X_train)):
    ...
    # Save model
    model_path = os.path.join(output_dir, f"L2_DropoutNN_fold{fold+1}.h5")
    ...
    metrics_df.to_csv(os.path.join(output_dir, "DL2_NN_Metrics_Avg.csv"), index=False)
...
plt.title('Confusion Matrix - L2 Regularized NN', fontsize=16)
...
plt.title('Training and Validation Accuracy - L2 Regularized NN', fontsize=16)
plt.legend()
plt.grid(True)
